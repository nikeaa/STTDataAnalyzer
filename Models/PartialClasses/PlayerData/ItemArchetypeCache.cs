...
namespace STTDataAnalyzer.Models.PlayerData
{
	...
	//{
	//	public IOrderedEnumerable<PdArchetype> GetItemsNotInSpaceBattles()
	//	{
	...
	//		foreach (PdArchetype archetype in Archetypes)
	//		{
	...
	//		PdArchetype item = Archetypes.Where(a => a.Symbol == itemSymbol).Select(a => a).FirstOrDefault();
	//		if (item != null)
	//		{
	...
	//				{
	//					PdArchetype subItem = Archetypes.Find(a => a.Id == item.Recipe.Demands[i].ArchetypeId);
	//					if (subItem != null)
	//					{
