...
namespace STTDataAnalyzer
{
    public class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            string jsonString = PlayerData.Get(false);
            ...
            //VoyageSkills voyageSkills = voyage.Skills;
            //List<CrewSlot> crewSlots = voyage.CrewSlots;

            List<VoyageDescription> voyageDescriptions = playerData.Player.Character.VoyageDescriptions;
            VoyageDescription voyageDescription = voyageDescriptions.First();
            string shipTrait = voyageDescription.ShipTrait;
            VoyageSkills voyageSkills = voyageDescription.Skills;
            List<CrewSlot> crewSlots = voyageDescription.CrewSlots;
            List<ShipElement> ships = playerData.Player.Character.Ships;
