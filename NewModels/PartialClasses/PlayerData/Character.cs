...
namespace STTDataAnalyzer.Models.PlayerData
{
	public partial class Character
	{
		...
		//public IOrderedEnumerable<PdCrew> GetSRThatAreThreeStar()
		//{
		...
		//public IEnumerable<PdCrew> GetCrewWithTwoSpecificSkills(string primarySkill, string secondarySkill)
		//{
		...
		//	PdCrewSlot[] voyageCrewSlots = voyageInfo.CrewSlots.ToArray();

		//	CrewMemberComparable[] crewScores = CalcualteCrewVoyageSkillValues(Crew.ToArray(), primarySkill, secondarySkill, voyageCrewSlots);
		...
		//	PdCrew[] populatedSlotCrews = new PdCrew[voyageCrewSlotCount];
		...
		//private static void GetUnusedCrewForVoyageSeat(CrewMemberComparable[] crewScores, string[] populatedSlotNames, PdCrew[] populatedSlotCrews, int v)
		//{
		...
		//private static CrewMemberComparable[] CalcualteCrewVoyageSkillValues(PdCrew[] crew, string primarySkill, string secondarySkill, PdCrewSlot[] voyageCrewSlots)
		//{
		//	int crewCount = crew.Count();
		//	CrewMemberComparable[] crewScores = new CrewMemberComparable[crewCount];

		//	// Calculate voyage scores for each crew for each skill
		//	for (int crewIndex = 0; crewIndex < crew.Count(); crewIndex++)
		//	{
		//		PdCrew crewMember = crew[crewIndex];
		//		crewScores[crewIndex] = new CrewMemberComparable(crewMember);
		//		for (int voyageSlotIndex = 0; voyageSlotIndex < voyageCrewSlots.Count(); voyageSlotIndex++)
		//		{
		//			PdCrewSlot voyageCrewSlot = voyageCrewSlots[voyageSlotIndex];
		...
		//private static void AdjustLowSkillValues(int commandTotal, int diplomacyTotal, int engineeringTotal, int medicineTotal, int scienceTotal, int securityTotal, PdCrew[] crew, string[] populatedSlotNames, PdCrew[] populatedSlotCrews, PdCrewSlot[] voyageCrewSlots)
		//{
		...
		//private static int GetSkillVoyageScore(PdCrew crewMember, string primarySkill, string secondarySkill, string currentSkill, string trait)
		//{
