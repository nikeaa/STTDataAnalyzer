...
namespace STTDataAnalyzer.Models.PlayerData
{
	public partial class PdCrew
	{
		...
		public List<PdEquipmentSlot> EquipmentSlots { get; set; }
		...
		[JsonProperty("skills")]
		public PdBaseSkillsClass Skills { get; set; }

		[JsonProperty("base_skills")]
		public PdBaseSkillsClass BaseSkills { get; set; }

		[JsonProperty("ship_battle")]
		public PdShipBattle ShipBattle { get; set; }
		...
		public PdCapAchiever CapAchiever { get; set; }
	}
}
