...
namespace STTDataAnalyzer.Models.PlayerData
{
	...
	{
		public IOrderedEnumerable<PdCrew> GetSRThatAreFFButNotFE()
		{
		...
		public IEnumerable<PdItem> GetItemsLeftToFE(string characterSymbol)
		{
		...
		private static void GetUnusedCrewForVoyageSeat(CrewMember[] crewScores, string[] populatedSlotNames, PdCrew[] populatedSlotCrews, int v)
		{
		...
		private static CrewMember[] CalcualteCrewVoyageSkillValues(PdCrew[] crew, string primarySkill, string secondarySkill, PdCrewSlot[] voyageCrewSlots)
		{
